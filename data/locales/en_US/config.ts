...
import { en_US_Project_Data } from "./projects";
import { en_US_Service_Data } from "./service";
import { en_US_Skills_Data } from "./skills";

export const en_US_Data: any = {
  navbar: en_US_Navbar_Data,
  landing: en_US_Landing_Data,
  projects: en_US_Project_Data,
  skills: en_US_Skills_Data,
  about: en_US_About_Data,
  service: en_US_Service_Data,
